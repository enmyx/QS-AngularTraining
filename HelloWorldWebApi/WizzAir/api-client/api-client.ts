...
export class CarsClient {
    ...
    constructor(@Inject(HttpClient) http: HttpClient, @Optional() @Inject(API_BASE_URL) baseUrl?: string) {
        this.http = http;
        this.baseUrl = baseUrl ? baseUrl : "https://localhost:44332";
    }
    ...
    protected processGetAll(response: HttpResponseBase): Observable<Car[]> {
    ...
    put(id: number, car: Car): Observable<void> {
        let url_ = this.baseUrl + "/api/Cars/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id)); 
...
export class Car implements ICar {
    ...
    toJSON(data?: any) {
        ...
        data["manufactured"] = this.manufactured;
        return data; 
    }
}
